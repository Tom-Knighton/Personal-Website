...
function MainPageHeader() {
  ...
  return (
    <div className={`fade-wrapper ${fadeState} max-w-4xl m-auto`} style={{ transitionDuration: `${1000}ms` }}>
      <h1>Hi, I'm Tom 👋</h1>
      <span>I am currently a third year student of Computer Science at Queen Mary University of London. I work mainly with Swift for iOS development and C#, but have experience with other OOP languages.
          ...
          as an intern developer at Mountain Warehouse, working in multiple teams across backend code, their frontend site as well as React Native apps.
      </span>
